...
export default function HeroSection() {
  return (
    <div
      ...
      style={{ backgroundImage: "url(/images/all-img/v3/hero-bg.png)" }}
    >
          ...
          <div className="col-lg-7">
            <div className="fugu--hero-content">
              ...
              <p className="wow fadeInUpX" data-wow-delay="0.10s">
                ...
                obcaecati laudantium natus. Dicta nemo tempora doloremque maxime
                vero. Eum placeat quasi natus, quos explicabo eos modi ex
                nostrum aspernatur totam.
              </p>
              <div
              ...
              >
                <Link href={"#"} legacyBehavior>
                  <a className="fugu--btn bg-gray active">
